//! Backend-agnostic font faces matching shadcn-svelte `@fontsource(-variable)` families.
//!
//! Raw TTF bytes only — no GUI-framework types. Backends adapt them to their
//! own font registries (e.g. `iced::application(...).font(...)`).
//!
...
pub const JETBRAINS_MONO_MEDIUM: &[u8] = include_bytes!("../assets/fonts/JetBrainsMono-Medium.ttf");

/// All faces to register with the backend font loader.
