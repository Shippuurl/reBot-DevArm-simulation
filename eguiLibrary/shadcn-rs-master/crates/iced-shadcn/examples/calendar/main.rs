...
#[cfg(feature = "chrono")]
use iced_shadcn::{CalendarAction, CalendarMode, CalendarProps, CalendarState, Theme, calendar};
...
impl Default for Example {
    fn default() -> Self {
        let initial = NaiveDate::from_ymd_opt(2024, 6, 1).unwrap();
        Self {
            theme: Theme::default(),
...
impl Example {
    ...
    fn view(&self) -> Element<'_, CalendarAction> {
        ...
        let content = column![
            iced_text("Calendar demo").size(20),
            calendar(
                CalendarProps::new("calendar")
